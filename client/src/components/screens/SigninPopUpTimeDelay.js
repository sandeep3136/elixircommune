...
const SigninPopUpTimeDelay = () => {
    ...
    return (
       ...
       {isLoading? '': <div className="z-depth-2 signin-wrapper">
           <i className="material-icons" style={{float:'right',cursor:'pointer'}} id="btnClosePopUp" >close</i>
...
export default ReactDelayRender({ delay: 15000 })(SigninPopUpTimeDelay)
