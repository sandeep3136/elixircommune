...
import '../../../css/PostEditions.css'
import M from 'materialize-css'
import {useHistory} from 'react-router-dom'
export default function PostEditions() {
        ...
        if(url){
            fetch("/post/postEditions",{
                ...
                if(data.error){
                    ...
                    M.toast({html:`${edition} posted successfully`,classes:"green darken-2"})
    ...
    return (
        ...
        <div className="pe-card">
          <div className="pe-card-body">
              <h4>Post Edition Here</h4>
            <div>
              <label>
                Edition No : &nbsp;
                <input style={{borderRadius:"0.25rem",border:'1px solid black',paddingLeft:'20px',width:"90px"}} value={edition} onChange={(e)=>setEdition(e.target.value)} />
              </label>
            </div>
            <div className="pe-card-title">Upload your file here</div>
            <div className="pe-card-subtitle">Maximum file size is 10MB</div>
            <div className="pe-file-upload file-field input-field">
              {/* <input className="pe-file-input" type="file"   /> */}
              <div class="file-field input-field">
                <div>
                    <span>Upload File</span>
                    <input  type="file" onChange={(e)=>setImge(e.target.files[0])} />
                </div>
